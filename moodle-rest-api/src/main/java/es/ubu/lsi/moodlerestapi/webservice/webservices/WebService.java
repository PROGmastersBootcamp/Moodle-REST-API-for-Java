...
public class WebService {
    ...
    public WebService(String host, String wstoken) {
        setData(host, wstoken, wstoken);
    }
    ...
    public Response getResponse(WSFunction wsFunction) throws IOException {
        ...
        formBody.add("wsfunction", wsFunction.getWSFunction().toString());
        formBody.add("moodlewsrestformat", moodleWSRestFormat);
        formBody.add("wstoken", token);

        for (String key : wsFunction.getParameters().keySet()) {
            Object param = wsFunction.getParameters().get(key);
            StringBuilder stringBuilder = new StringBuilder(key);
            jsonToQueryParam(formBody, stringBuilder, param);
        }
